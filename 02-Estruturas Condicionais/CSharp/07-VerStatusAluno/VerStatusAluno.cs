...
// Nota de adaptação: No C# há a possibilidade de utilizar o
// "else if()" para checagens repetitivas como abaixo.

// Checagem "if hadowken". Não adequada, porém evita 'n' operacoes
// Se comparada em "if" independente para cada caso
